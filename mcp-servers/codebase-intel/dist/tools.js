    ...
    return [
        {
            ...
            description: "Detect languages, frameworks, test runners, and build tools for a " +
        ...
        },
        {
            ...
            description: "Rank files by git churn (commits × lines changed) over a window. " +
        ...
        },
        {
            ...
            description: "Build the import graph for TS/JS files under a project root. " +
        ...
        },
        {
            ...
            description: "Grep the source tree for TODO/FIXME/HACK/XXX/@deprecated markers. " +
