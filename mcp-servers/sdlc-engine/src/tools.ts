import { z } from "zod";
import { SdlcEngine, PhaseTransitionError } from "./engine.js";
  ...
  return [
    {
      ...
      description:
        "List the ordered SDLC phases with entry/exit criteria. " +
    ...
    },
    {
      name: "sdlc_get_state",
      description:
        "Fetch the current SDLC state for a project. Initializes state at " +
    ...
    },
    {
      ...
      description:
        "Mark an exit criterion as satisfied for the project's current phase.",
      inputSchema: {
        type: "object",
        properties: {
          projectId: { type: "string", minLength: 1 },
    ...
    },
    {
      ...
      description:
        "Record a multi-AI consensus outcome. `status` accepts any case " +
    ...
    },
    {
      ...
      description:
        "Advance the project to the next phase. Validates phase order, " +
