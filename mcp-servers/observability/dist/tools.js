...
import { z } from "zod";
import { parseReporter, ReporterParseError, } from "./parsers.js";
import { computeMetrics } from "./metrics.js";
import { analyzeHistory, analyzeHistoryDir, loadHistoryDir, } from "./flakiness.js";
    ...
    return [
        {
            ...
            description: "Parse a test-runner reporter (vitest/jest/playwright JSON) into " +
        ...
        {
            name: "ob_track_flaky",
            description: "Analyze a history of normalized runs for flaky and regressing " +
        ...
        {
            name: "ob_perf_trend",
            description: "Compute an execution-time trend over a history of runs. Reports " +
        ...
        },
        {
            ...
            description: "Build a compact health-grade summary (green/yellow/red) from a " +
