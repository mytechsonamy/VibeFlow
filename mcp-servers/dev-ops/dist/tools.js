    ...
    return [
        {
            ...
            description: "Dispatch a CI workflow (GitHub Actions) on a given ref with " +
        ...
        },
        {
            ...
            description: "Fetch the status + conclusion of a CI run. Returns a normalized " +
        ...
        },
        {
            ...
            description: "List artifacts for a CI run — returns download URLs, never " +
        ...
        },
        {
            ...
            description: "Dispatch a deploy workflow with an explicit environment input. " +
        ...
        {
            name: "do_rollback",
            description: "Dispatch a rollback workflow with the target ref + a required " +
