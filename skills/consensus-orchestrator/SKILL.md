...
append_cli_verdict() {
  ...
  # Unwrap the verdict JSON FIRST (Sprint 31 fix), so a fenced/prose-wrapped
  # reviewer reply still yields criticalIssues + suggestions, not just a
  # keyword-grep verdict with empty rationale.
