...
- Total baseline: **1489 passing checks** across **12 test layers** (1493 in live mode). Sprint 4 ✅ COMPLETE + v1.0.0 shipped. Sprint 5 ✅ COMPLETE + v1.0.1 shipped. Sprint 6 ✅ COMPLETE + **v1.1.0 shipped 2026-04-16**. Sprint 7 seeded at `docs/SPRINT-7.md` (S6-02/03/06 deferred in).
